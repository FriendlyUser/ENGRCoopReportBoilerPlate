...
\end{warpHTML}
		...
		% Rewrite here.
		The desirable propertiies of a blockchain such as integrity and immutability of data, e.g., transactions and
		...
		i.e. computational power, to participate in the consensus process and prevent tampering blocks. The investment must incentivize miners to verify transactions and/or run nodes.%This investment has to be incentivized to prevent miners from not participating.
%	\end{minipage}
%	\begin{minipage}[h]{0.5\linewidth}
